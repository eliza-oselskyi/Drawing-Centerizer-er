...
public class CenterOptionsDialogViewModel : INotifyPropertyChanged
{
    ...
    /// </summary>
    /// <remarks>
    ///     This method is registered as an event handler for selection change events in the Tekla Structures drawing
    ///     interface.
    ...
    ///     Subscribed to <see cref="Tekla.Structures.Drawing.UI.Events.DocumentManagerClosed" /> to reset state when the
    ///     document is closed.
    /// </events>
    ...
    /// </returns>
    private async Task CenterDrawingsCore(Func<Tekla.Structures.Drawing.Drawing, bool> drawingFilter,
        IViewCenteringStrategy strategy, bool useSelectedOnly = false)
    {
    ...
    private static IViewCenteringStrategy GetAppropriateStrategy(Tekla.Structures.Drawing.Drawing drawing)
    {
    ...
    private static bool IsGaDrawing(Tekla.Structures.Drawing.Drawing drawing)
    {
        return drawing is GADrawing;
    }
